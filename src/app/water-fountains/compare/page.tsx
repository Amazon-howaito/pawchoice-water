...
export const metadata:Metadata={title:"循環式ペット給水器を2〜4商品で比較",description:"容量、材質、電源、フィルター、アプリなどを2〜4商品で横並び比較。",alternates:{canonical:"/water-fountains/compare"},robots:{index:false,follow:true},openGraph:{url:"/water-fountains/compare",title:"給水器を仕様比較",images:[OPEN_GRAPH_IMAGE]}};
